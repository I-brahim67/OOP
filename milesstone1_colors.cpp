    ...
    void submenu()
    {
        ...
        do
        {
            ...
            case 1:
                ...
                break;
            case 2:
                cout << RED << "Remove User Record - Feature not implemented yet." << RESET << endl;
                break;
            case 3:
                cout << RED << "View User Records - Feature not implemented yet." << RESET << endl;
                break;
            case 4:
                cout << RED << "Edit User Record - Feature not implemented yet." << RESET << endl;
                break;
            case 5:
    ...
    void submenu()
    {
        ...
        do
        {
            ...
            case 1:
                ...
                break;
            case 2:
                cout << RED << "Remove Account Record - Feature not implemented yet." << RESET << endl;
                break;
            case 3:
                cout << RED << "View Account Records - Feature not implemented yet." << RESET << endl;
                break;
            case 4:
                cout << RED << "Edit Account Record - Feature not implemented yet." << RESET << endl;
                break;
            case 5:
